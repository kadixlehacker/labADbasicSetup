...
7. Installez Windows 10 dans une autre machine virtuelle, puis rejoignez-le au domaine créé précédemment.
        ...
        #######################################################################
	Pour approfondir davantage, nous allons explorer quelques techniques d'énumération post-exploitation.
        Nous supposerons que nous avons obtenu récemment des identifiants suite à une attaque de phishing ou à une 
	...
	10. Utilisez la commande "runas" sur Windows pour injecter les identifiants volés dans la mémoire de 
	la machine Windows attaquante. 
        Assurez-vous d'ajouter la fonctionnalité RSAT (Remote Server Administration Tools) comprenant 
	Active Directory Domain Services 
	et Lightweight Directory Tools sur la machine Windows attaquante.
        11. Utilisez la console MMC (Microsoft Management Console) pour effectuer l'énumération des informations.
	12. Utilisez Bloodhound, un outil d'énumération, sur la machine Kali Linux pour obtenir davantage 
	d'informations.
