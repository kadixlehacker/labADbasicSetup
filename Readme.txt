...
7. Installez Windows 10 dans une autre machine virtuelle, puis rejoignez-le au domaine créé précédemment.
	 ...
	 Nous supposerons que nous avons obtenu récemment des identifiants suite à une attaque de phishing ou à une phase de reconnaissance
	...
	10. Utilisez la commande "runas" sur Windows pour injecter les identifiants volés dans la mémoire de la machine Windows attaquante. 
        Assurez-vous d'ajouter la fonctionnalité RSAT (Remote Server Administration Tools) comprenant Active Directory Domain Services 
